        ...
        public function Login()
        {
            ...
            if (isset($_POST['login'])) {
                ...
                if (empty($_POST['login']) || empty($_POST['password'])) {
                    ...
                    $verify_login = $this->model->verifyLoginData($_POST['login'],
                        $_POST['password']);
                ...
                if (trim($_POST['otp']) == $_SESSION['reg_otp']) {
                    if ($this->model->register()) {
                        ...
                        if (VERIFY_EMAIL_AT_REGISTRATION) {
                            ...
                            $notification->setData('VERYFY_LINK',
            ...
            if (isset($_POST['email'])) {
                ...
                if (empty($data['name_err']) && empty($data['email_err']) &&
                    ...
                    if (VERIFY_PHONE_AT_REGISTRATION) {
                        ...
                        $sms_sender->sendSMS($data['mobile'],
                    ...
                    if (time() < strtotime($recovery['expire'])) {
                        ...
                        if (isset($_POST['password'])) {
                            ...
                            if (empty($data['password_err']) &&
                                ...
                                if ($this->model->setPassword($recovery['user_id'],
                                    password_hash($data['password'], PASSWORD_DEFAULT))) {
                                    $notification = new Notification;
