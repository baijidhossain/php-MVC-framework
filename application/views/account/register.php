...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg"><?= $data['page_heading']; ?></p>
        <?php
        ...
        <?php else: ?>
            ...
            <form style="margin-bottom:10px;" action="" method="post" autocomplete="off" id="reg_form">
                <div class="form-group has-feedback <?= (!empty($data['name_err']) ? 'has-error' : '') ?>">
                    <input type="text" class="form-control" name="name" placeholder="Full name"
                           value="<?= $data['name']; ?>"
                           required>
                    <span class="glyphicon glyphicon-user form-control-feedback"></span>
                    <span class="help-block"><?= $data['name_err']; ?></span>
                </div>
                <div class="form-group has-feedback <?= (!empty($data['email_err']) ? 'has-error' : '') ?>">
                    <input type="email" class="form-control" name="email" placeholder="Email"
                           value="<?= $data['email']; ?>"
                           required>
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                    <span class="help-block"><?= $data['email_err']; ?></span>
                </div>
                <div class="form-group has-feedback <?= (!empty($data['mobile_err']) ? 'has-error' : '') ?>">
                    <input type="text" class="form-control" name="mobile" placeholder="Mobile"
                           value="<?= $data['mobile']; ?>"
                           required>
                    <span class="glyphicon glyphicon-phone form-control-feedback"></span>
                    <span class="help-block"><?= $data['mobile_err']; ?></span>
                </div>
                <div class="form-group has-feedback <?= (!empty($data['country_err']) ? 'has-error' : '') ?>">
                    <select class="form-control all-country" name='country' id="country" required>
                    ...
                    <span class="help-block" id="not_available"><?= $data['country_err']; ?></span>
                </div>
                        ...
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox" name="agree" required> <span
                                        style="vertical-align: middle; margin-left: 2px;">I
                  agree to the <a href="<?= APP_URL ?>/terms_and_conditions" target="_blank">terms</a></span>
                            </label>
                        </div>
                    </div>
                    <!-- /.col -->
            ...
            <a href="<?= APP_URL ?>/account/login" class="text-center">I already have an account</a>
