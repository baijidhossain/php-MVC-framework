<aside class="main-sidebar ">
    ...
    <section class="sidebar">
        ...
        <?php
            ...
            $menus = $db->query("SELECT m.* FROM navigation AS m JOIN nav_permission AS p ON p.nav_id=m.id WHERE p.group_id IN (SELECT group_id FROM user_group_relation WHERE user_id=?) ORDER BY m.sort,m.id", $_SESSION['userid'])->fetchAll();
