...
<div class="wrapper">
        ...
        <div class="col-md-12">
          <div class="box box-widget">
            <div class="box-header with-border ">
              ...
              <div class="box-tools">
                <a href="<?= APP_URL ?>/admin/country/add" class="btn btn btn-sm bg-color " data-toggle="modal" data-target="#myModal">
                ...
                <table class="table table-striped border  table-bordered ">
                  ...
                  <tbody>
                    ...
                    if (empty($data['countries'])) {
                      ...
                      foreach ($data['countries']['paginateData'] as  $country) { ?>
                        <tr>

                          <td><?= $country['name']; ?></td>
                          <td>
                            <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/country/edit/<?= $country['id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
                            &nbsp;
                            <a href="javascript:runDelete(<?= $country['id'] ?? "" ?>)" class="text-red"><i class="fa fa-trash"></i> Delete</a>
                          </td>
                        </tr>
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-md-6">
                  <?= $data['countries']['paginateInfo']; ?>
                </div>

                <div class="col-md-6">
                  <?= $data['countries']['paginateNav']; ?>
                </div>
  ...
  <script>
    function runDelete(id) {
      ...
      if (conf) {
        window.location = "<?= APP_URL ?>/admin/country/delete/" + id;
      }
    }
  </script>