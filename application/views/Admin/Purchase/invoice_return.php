...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="<?= APP_URL ?>/admin/purchase_return/add" method="post" id="form" enctype="multipart/form-data">
        <div style="margin-top: 20px;" class="row">
          <input name="purchase_id" hidden type="text" value="<?= $data['purchase']['id'] ?? "" ?>">
          <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <select datapleaceholder="jo" class="form-control " name="supplier" readonly>
                        <?php
                        foreach ($data['suppliers'] as  $supplier) {

                          if ($data['purchase']['supplier'] == $supplier['id']) { ?>
                  ...
                  <div class=" col-md-1">
                    <div class="form-group">
                      <label for="">Purchase Bill No</label>
                      <br>
                  ...
                  <table class="table table-striped  table-condensed mb-0">
                    ...
                    <tfoot class="  text-bold text-right">
                      ...
                      <tr>
                        <td colspan="8"></td>
                        <td colspan="2">
                          <button type="button" onclick="invoiceUpdate()" class="btn bg-color invoiceUpdate " style="width:100px;"> Update </button>
                        </td>
                      </tr>
              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="col-md-12 text-right">
                    <button type="submit" class="btn  bg-color save float-right" style="width:100px;">Save</button>
                  </div>
                </div>
