...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="<?= APP_URL ?>/admin/purchase/update/<?= $data['purchase']['id'] ?? "" ?>" method="post" id="form" enctype="multipart/form-data">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="status">
                        ...
                        <option <?= $data['purchase']['status'] == 'Received' ? 'selected' : '' ?> value="Received">Received</option>
                        <option <?= $data['purchase']['status'] == 'Pending' ? 'selected' : '' ?> value="Pending">Pending</option>
                        <option <?= $data['purchase']['status'] == 'Received' ? 'Ordered' : '' ?> value="Ordered">Ordered</option>
                      </select>
                    </div>
                  </div>
