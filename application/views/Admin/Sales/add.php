...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="<?= APP_URL ?>/admin/sales/add" method="post" id="form" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="sales_date" value="<?= date("Y-m-d") ?>">
                    </div>
                  </div>
                      ...
                      if (empty($_SESSION['product'])) {
                        ...
                        foreach ($_SESSION['product'] as $key => $product) { ?>
                          ...
                          <tr class="newrow">
                            ...
                            <td class="text-right">
                              <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/sales/invoice/edit/<?= $key ?>"> <i class="fa fa-pencil text-primary"> </i> </a>
                              &nbsp;&nbsp;
                              <a href="<?= APP_URL ?>/admin/sales/invoice/itemRemove/<?= $key ?>"> <i class="fa fa-trash text-danger "> </i> </a>
                            </td>
