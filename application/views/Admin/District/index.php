...
<div class="wrapper">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border ">
              ...
              <div class="box-tools">
                <a href="<?= APP_URL ?>/admin/district/add" class="btn btn btn-sm btn-primary " data-toggle="modal" data-target="#myModal">
                ...
                <table class="table table-striped border  table-bordered ">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 100px;">District Name</th>
                  ...
                  <tbody>
                    ...
                    if (empty($data['districts'])) {
                      ...
                      foreach ($data['districts']['paginateData'] as  $district) { ?>
                        <tr>

                          <td><?php echo $district['name']; ?></td>
                          <td>
                            <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/district/edit/<?= $district['id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
                            &nbsp;
                            <a href="javascript:runDelete(<?= $district['id'] ?>)" class="text-red"><i class="fa fa-trash"></i> Delete</a>
                          </td>
                        </tr>
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-md-6">
                  <?php
                  echo $data['districts']['paginateInfo'];
                  ?>
                </div>

                <div class="col-md-6">
                  <?php
                  echo $data['districts']['paginateNav'];
                  ?>
                </div>
  ...
  <script>
    function runDelete(id) {
      ...
      if (conf) {
        window.location = <?= APP_URL ?> "/admin/district/delete/" + id;
      }
    }
  </script>