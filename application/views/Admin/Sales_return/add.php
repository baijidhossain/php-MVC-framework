...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="<?= APP_URL ?>/admin/sales_return/add" method="post" id="form" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <select datapleaceholder="jo" class="form-control select2" name="customer">
                      ...
                      if (empty($_SESSION['product'])) {
                        ...
                        foreach ($_SESSION['product'] as $key => $product) { ?>
                          ...
                          <tr class="newrow">
                            ...
                            <td class="text-right">
                              <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/purchase_return/invoice/edit/<?= $key ?>"> <i class="fa fa-pencil text-primary"> </i> </a>
                              &nbsp;&nbsp;
                              <a href="<?= APP_URL ?>/admin/purchase_return/invoice/itemRemove/<?= $key ?>"> <i class="fa fa-trash text-danger "> </i> </a>
                            </td>
  ...
  <script>
    $(document).ready(function() {
      ...
      $('.product').change(function() {
        ...
        var url = "/admin/sales_return/invoice/add";
        $.ajax({
          url: url,
          type: "POST",
          data: {
