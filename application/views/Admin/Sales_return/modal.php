...
if ($data['action'] == "paynow") { ?>
  ...
  <div class="modal-header">
    ...
    <div class="row invoice-info">
      <div class="col-sm-4 invoice-col">
        ...
        <address>
          Name: <?= $data['customer']['name'] ?? '' ?>nnnnnjnjnjnjnjn
          <br>
      ...
      <div class="col-sm-4 invoice-col">
        ...
        <address>
          <b>Invoice #<?= $data['salesreturnInvoice']['bill_no'] ?></b><br>
          <b>Date :<?= date_create($data['salesreturnInvoice']['purchase_date'] ?? "")->format('d M, Y')  ?></b><br>
          <b>Grand Total :<?= $data['salesreturnInvoice']['grandtotal'] ?? '' ?></b><br>
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Paid Amount :<span><?= $data['salesreturnInvoice']['paid'] ?? '' ?></span></b><br>
        <b>Due Amount :<span id="due_amount_temp"><?= $data['salesreturnInvoice']['due'] ?? '' ?></span></b><br>
  ...
  <form onsubmit method="POST" action="<?= APP_URL ?>/admin/sales_return/paynow/<?= $data['salesreturnInvoice']['id'] ?? '' ?>/<?= $data['customer']['id'] ?? '' ?>">
    <div class="modal-body">

      <div class="box-body">

        <div class="row">
          <input type="text" hidden name="id" value="<?= $data['salesreturnInvoice']['id'] ?? '' ?>">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <input name="paid_amount" type="text" class="form-control paid_amount" value="<?= $data['salesreturnInvoice']['due'] ?? '' ?>" placeholder="Amount">
            </div>
