        ...
        <div class="col-md-12">
          <div class="box box-widget">
            <div class="box-header with-border ">
              ...
              <div class="box-tools">
                <a href="<?= APP_URL ?>/admin/unit/add" class="btn btn btn-sm bg-color " data-toggle="modal" data-target="#myModal">
              ...
              <div class="table-responsive">
                <table class="table table-striped border  table-bordered ">
                  ...
                  <tbody>
                    ...
                    if (empty($data['units']['paginateData'])) {
                      echo '<tr><td colspan="10"> No Data Found</td></tr>';
                    } else {
                      foreach ($data['units']['paginateData'] as  $unit) { ?>
                        <tr>

                          <td><?php echo $unit['name']; ?></td>
                          <td>
                            <a class=" text-purple" data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/unit/edit/<?php echo $unit['id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
                            &nbsp;
                            <a class="text-danger" href="javascript:runDelete(<?php echo $unit['id'] ?>)" ><i class="fa fa-trash"></i> Delete</a>
                          </td>
                        </tr>
            ...
            <div class="box-footer">
              ...
              <?php
              echo $data['units']['paginateInfo'];
              ?>

              <?php
              echo $data['units']['paginateNav'];
              ?>
...
<script>
  function runDelete(id) {
    ...
    if (conf) {
      window.location = '<?= APP_URL ?>/admin/unit/delete/' + id;
    }
  }
</script>