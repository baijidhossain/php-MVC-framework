                        ...
                        <td class="text-center">
                          ...
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right border">
                              <li>
                                <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/customers/view/<?php echo $customer['id'] ?>"><i class="fa fa-pencil"></i> View</a>
                              </li>
                              ...
                              <li>
                                ...
                                <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/customers/edit/<?php echo $customer['id'] ?>"><i class="fa fa-pencil"></i> Pay</a>
                              </li>

                              <li>
                                <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/customers/edit/<?php echo $customer['id'] ?>"><i class="fa fa-pencil"></i> Sale</a>
                              </li>

                              <li>
                                <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/customers/edit/<?php echo $customer['id'] ?>"><i class="fa fa-pencil"></i> Ledger Report</a>
                              </li>
                            </ul>
                          </div>
