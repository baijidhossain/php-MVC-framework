          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              <div class="row invoice-info">
                ...
                <!-- /.col -->
                <div class="col-sm-4 invoice-col">
                  <b>Invoice #<?= $data['purchaseReturn']['bill_no'] ?></b><br>
                  <b>Purchase Status :<?php


                                      if ($data['purchaseReturn']['status']  == 1) {
                                        echo 'Received';
                                      } elseif ($data['purchaseReturn']['status']  == 2) {
                                        echo 'Pending';
                                      } elseif ($data['purchaseReturn']['status']  == 3) {
                                        echo 'Ordered';
                                      }
                ...
                <div class="col-xs-12 table-responsive">
                  <table class="table table-striped table-bordered  table-condensed mb-0">
                    ...
                    <tbody>
                      ...
                      foreach ($data['purchaseReturnProducts'] as  $prodact) { ?>
                        <tr>
                    ...
                    <tfoot class="text-bold ">
                      <tr class="bg-gray">
                        ...
                        <td> <?= array_sum(array_column($data['purchaseReturnProducts'], "qty")) ?></td>
                        <td><?= array_sum(array_column($data['purchaseReturnProducts'], "purchase_price")) ?></td>
                        <td></td>
                        <td><?= array_sum(array_column($data['purchaseReturnProducts'], "discount_amount")) ?></td>
                        <td></td>
                        <td><?= array_sum(array_column($data['purchaseReturnProducts'], "tax_amount")) ?></td>
                        <td><?= array_sum(array_column($data['purchaseReturnProducts'], "unit_cost")) ?></td>
                        <td><?= array_sum(array_column($data['purchaseReturnProducts'], "total_amount")) ?></td>
                      </tr>

                      <tr>
                        <td colspan="9" class="text-right">Subtotal : </td>
                        <td><?= $data['purchaseReturn']['subtotal'] ?? "" ?></td>
                      </tr>
                      <tr>
                        <td colspan="9" class="text-right">Other Cherges/Fixed : </td>
                        <td><?= $data['purchaseReturn']['other_charges'] ?? "" ?></td>
                      </tr>
                      <tr>
                        <td colspan="9" class="text-right">Discount : </td>
                        <td><?= $data['purchaseReturn']['discount_on_all'] ?? "" ?></td>
                      </tr>

                      <tr>
                        <td colspan="9" class="text-right">Grandtotal : </td>
                        <td><?= $data['purchaseReturn']['grandtotal'] ?? "" ?></td>
                      </tr>
                    ...
                    <table class="table table-striped table-bordered  table-condensed mb-0" style="width:100%">
                      ...
                      <tfoot class="text-bold ">
                        ...
                        <tr>
                          ...
                          <td><?= $data['purchaseReturn']['paid'] ?? "" ?></td>
                        </tr>

                        <tr>
                          <td colspan="4" class="text-right">Receivable Due : </td>
                          <td><?= $data['purchaseReturn']['due'] ?? "" ?></td>
                        </tr>
                      </tfoot>
                    </table>
                  </div>
