...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="<?= APP_URL ?>/admin/purchase_return/update/<?= $data['purchase']['id'] ?? "" ?>" method="post" id="form" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                      ...
                      <select datapleaceholder="jo" class="form-control select2" name="supplier">
                        ...
                        foreach ($data['suppliers']['paginateData'] as  $supplier) { ?>
                          <option <?= $data['purchase']['supplier'] == $supplier['id'] ? "selected" : "" ?> value="<?= $supplier['id'] ?>"><?= $supplier['name'] ?></option>
                        <?php } ?>
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="purchase_date" value="<?= date_create($data['purchase']['purchase_date'])->format('Y-m-d') ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" name="status">
                        ...
                        <option <?= $data['purchase']['status'] == 'Return' ? 'selected' : '' ?> value="Return">Return</option>
                        <option <?= $data['purchase']['status'] == 'Cancel' ? 'selected' : '' ?> value="Cancel">Cancel</option>
                  ...
                  <div class=" col-md-4">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="note" rows="1" style="resize: vertical;"><?= $data['purchase']['note'] ?? "" ?></textarea>
                    </div>
                  </div>
