                ...
                <table class="table table-striped  table-bordered table-condensed ">
                  ...
                  <tbody>
                    ...
                    <?php
                      $i++;
                      $qty += $prodact['qty'] ?? 0;
                      $PurchasePrice += $prodact['purchase_price'] ?? 0;
                      $DiscountAmount += $prodact['discount_amount'] ?? 0;
                      $TaxAmount += $prodact['tax_amount'] ?? 0;
                      $UnitCost += $prodact['unit_cost'] ?? 0;
                      $TotalAmount += $prodact['total_amount'] ?? 0;
                    } ?>
