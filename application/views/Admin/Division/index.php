...
<div class="wrapper">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border ">
              ...
              <div class="box-tools">
                <a href="<?= APP_URL ?>/admin/division/add" class="btn btn btn-sm btn-primary " data-toggle="modal" data-target="#myModal">
                ...
                <table class="table table-striped border  table-bordered ">
                  ...
                  <tbody>
                    ...
                    if (empty($data['divisions'])) {
                      ...
                      foreach ($data['divisions']['paginateData'] as  $division) { ?>
                        <tr>

                          <td><?php echo $division['name']; ?></td>
                          <td>
                            <a data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/division/edit/<?= $division['id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
                            &nbsp;
                            <a href="javascript:runDelete(<?= $division['id'] ?>)" class="text-red"><i class="fa fa-trash"></i> Delete</a>
                          </td>
                        </tr>
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-md-6">
                  <?php
                  echo $data['divisions']['paginateInfo'];
                  ?>
                </div>

                <div class="col-md-6">
                  <?php
                  echo $data['divisions']['paginateNav'];
                  ?>
                </div>
  ...
  <script>
    function runDelete(id) {
      ...
      if (conf) {
        window.location = <?= APP_URL ?> "/admin/division/delete/" + id;
      }
    }
  </script>