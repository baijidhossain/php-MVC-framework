...
<div class="wrapper">
        ...
        <div class="col-md-12">
          <div class="box box-widget">
            <div class="box-header with-border ">
              ...
              <div class="box-tools">
                <a href="<?= APP_URL ?>/admin/color/add" class="btn btn btn-sm bg-color " data-toggle="modal" data-target="#myModal">
                ...
                <table class="table table-striped border  table-bordered ">
                  <thead class="bg-color">
                    <tr>
                      ...
                      <th style="width: 400px;"> Color Name</th>
                      <th style="width: 80px;"> Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php
                    foreach ($data['color']['paginateData'] as  $color) { ?>
                      <tr>

                        <td><?= $color['name']; ?></td>
                        <td>
                          <a class=" text-purple" data-toggle="modal" data-target="#myModal" href="<?= APP_URL ?>/admin/color/edit/<?= $color['id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
                          &nbsp;&nbsp;
                          <a class="text-danger" href="javascript:runDelete(<?= $color['id'] ?>)"><i class="fa fa-trash"></i> Delete</a>
                        </td>
                      </tr>
            ...
            <div class="box-footer">
              <div class="row">
                ...
                <div class="col-md-6">
                  <?php
                  echo $data['color']['paginateInfo'];
                  ?>
                </div>

                <div class="col-md-6">
                  <?php
                  echo $data['color']['paginateNav'];
                  ?>
                </div>
  ...
  <script>
    function runDelete(id) {
      ...
      if (conf) {
        window.location = '<?= APP_URL ?>/admin/color/delete/' + id;
      }
    }
  </script>